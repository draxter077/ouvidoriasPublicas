export default function title(){
    document.getElementsByTagName("style")[0].innerHTML += `
        .initContentSliderLeftSideBodyMenuUpperEventsTitle{
        ...
        .initContentSliderLeftSideBodyMenuUpperEventsTitle:hover{
            border: 4px solid var(--colorOrange) !important;
        }
    `

    const title = document.createElement("div")
    title.className = "initContentSliderLeftSideBodyMenuUpperEventsTitle"
